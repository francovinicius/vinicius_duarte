    ...
    return (
        <div className='w-full h-full relative'>
            <motion.div
                ...
                <motion.svg className='w-[300px] xl:w-[500px] h-[300px] xl:h-[500px]' fill='transparent' viewBox='0 0 506 506'
                    xmlns='http://www.w3.org/2000/svg'>
                    <motion.circle cx='253' cy='253' r='250' stroke='#00ff99' strokeLinecap='round' strokeLinejoin='round'
